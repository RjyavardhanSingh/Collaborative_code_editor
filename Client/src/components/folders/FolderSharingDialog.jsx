...
export default function FolderSharingDialog({ folderId, onClose }) {
  ...
  const handleInvite = async (e) => {
    ...
    try {
      ...
      // Simplified request - no selectedFiles
      const requestData = {
        email,
        permission,
      };
      ...
      setInviteStatus({
        success: true,
        message: "Invitation sent successfully - entire project shared",
      });
      setEmail("");
    } catch (err) {
        ...
        <div className="mb-6">
          <div className="bg-slate-700/50 p-3 rounded-md mb-4">
            <p className="text-sm text-slate-300">
              Share this entire project with collaborators. They will have
              access to all files and folders within this project.
            </p>
          </div>
          ...
          <form onSubmit={handleInvite} className="mb-4">
            ...
            >
              {inviteStatus?.loading ? "Sending..." : "Share Entire Project"}
            </button>
          </form>
